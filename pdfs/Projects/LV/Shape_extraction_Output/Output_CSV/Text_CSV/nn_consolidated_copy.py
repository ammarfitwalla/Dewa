...
def create_box_to_box_list(i):
    ...
    while True:
        ...
        # i_index = box_to_box_done_i.index(i)
        ...
        if list_i == len(coordinates) - 1:
            ...
            # print("Min Box List ", min_box_list)
            # print("Min Index ", current_box.index(min(current_box)))
            # print("Min Index Value ", min_box_list[current_box.index(min(current_box))])
            box_to_box.append(min_box_list[current_box.index(min(current_box))])
            # box_to_box_done_i.append(i)
            # box_to_box_done_list_i.append(min_box_index[current_box.index(min(current_box))])
            i += 1
            # if i > len(coordinates) - 2:
            #     return
            # else:

            return create_box_to_box_list(i)
        list_i += 1


create_box_to_box_list(i)
